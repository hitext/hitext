...
import { applyResetOrigin, generateRanges } from '../../src/index.js';
...
describe('applyResetOrigin', () => {
    it('should discard existing origin', () => {
        ...
        const ranges = generateRanges('hello world', applyResetOrigin()(input));
        deepStrictEqual(rangeWithoutMarker(ranges), [[0, 5, 'test', undefined]]);
    });

    it('should keep origin undefined when no existing origin', () => {
        const ranges = generateRanges('hello world', applyResetOrigin()([[0, 5], [6, 11]]));
    ...
    it('should discard complex array origins', () => {
        ...
        const ranges = generateRanges('hello world test', applyResetOrigin()(input));
        deepStrictEqual(rangeWithoutMarker(ranges), [
            [0, 5, 'a', undefined],
            [6, 11, 'b', undefined]
        ]);
