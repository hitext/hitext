...
5. [Layers and Materialization](5-layers-and-materialization.md) binds analytical span sources to output-specific hooks.
6. [Rendering Overlapping Spans](6-rendering-overlapping-spans.md) defines advanced intersection, segment, replacement, and ordering behavior.
